...
function renderBlock(b) {
  ...
  switch (b.type) {
    ...
    case 'image': {
      ...
      if (layout === 'side' || layout === 'panel') {
        return '<figure class="a-figure a-figure-' + layout + '">' +
...
module.exports = { renderBlocks, renderBlock, BLOCK_TYPES, OPENING_SOURCES, IMAGE_LAYOUTS, esc, inline, paragraphs };
